...
class MansionLevel5 {
    constructor(gameEnv) {
        ...
        this.backgroundMusic = new Audio(this.path + '/assets/sounds/mansiongame-old/SpookieDookie.mp3');
    ...
    createBackgroundData() {
        return {
            ...
            src: this.path + "/images/projects/mansiongame-old/background_lvl5.png",
    ...
    createPlayerData() {
        return {
            ...
            src: this.path + "/images/projects/mansiongame-old/full_anims_spook.png",
            SCALE_FACTOR: 5,
            STEP_FACTOR: 800,
            ANIMATION_RATE: 20,
    ...
    createWheelHostData() {
        return {
            ...
            src: this.path + "/images/projects/mansiongame-old/skeleton_key.png", 
            SCALE_FACTOR: 8,
            ANIMATION_RATE: 100,
    ...
    createFinishDoorData() {
        ...
        return {
            ...
            src: this.path + "/images/projects/mansiongame-old/door_lvl5.png",
            SCALE_FACTOR: 1,
            ANIMATION_RATE: 100,
    ...
    winLevel() {
        ...
        dialogueSystem.showDialogue(
            ...
            'Level 5 Complete',
            this.path + '/images/projects/mansiongame-old/key_lvl3.png'
        );
    ...
    showSolvedMessage() {
        ...
        dialogueSystem.showDialogue(
            ...
            'Mansion Wheel',
            this.path + '/images/projects/mansiongame-old/objective.png'
        );
    }
