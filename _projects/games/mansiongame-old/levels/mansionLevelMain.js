...
class MansionLevelMain {
  constructor(gameEnv) {
    ...
    // Background data
    const image_src_mainworld = path + "/images/projects/mansiongame-old/newMansionInterior.png"; // be sure to include the path
    ...
    */
    ...
    function getDoorData(levelNum, levelClass, x, y, localStorageLocked = false) {
      const sprite_src_level_door = path + "/images/projects/mansiongame-old/invisDoorCollisionSprite.png";
    ...
    const arrowData = {
      ...
      src: path + "/images/projects/mansiongame-old/redArrowDown.png",
