...
class Projectile extends Character {
    ...
    constructor(gameEnv = null, targetx, targety, sourcex, sourcey, type, options = {}) {
        ...
        if (type === "ARROW" || type === "PLAYER") {
            this.width = 60;
            this.height = 25;
            this.setSprite(path + "/images/projects/mansiongame-old/arrow.png");
        } else if (type === "PUMPKIN") {
            this.width = 48;
            this.height = 48;
            this.setSprite(path + "/images/projects/mansiongame-old/pumpkin.png");
        } else if (type === "FIREBALL") {
            this.width = 64;
            this.height = 44;
            this.setSprite(path + "/images/projects/mansiongame-old/staticfireball.png");
        }
