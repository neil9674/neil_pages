...
class MansionLevel6 {
    constructor(gameEnv) {
        ...
        const levelMusic = new Audio(path + `/assets/sounds/mansiongame-old/${randomSong}`);
                ...
                this.dialogueSystem.addButtons([
                    {
                        ...
                        action: () => {
                            ...
                            if (gameEnv && gameEnv.gameControl) {
                                ...
                                const audio = new Audio(path + "/assets/sounds/mansiongame-old/SkeletonLord.mp3");
                                audio.loop = true;
                                audio.volume = 0.4;
        ...
        const sprite_src_chairs = path + "/images/projects/mansiongame-old/invisDoorCollisionSprite.png";
